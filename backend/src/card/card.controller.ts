...
export class CardController {
  ...
  @ApiResponse({ status: 200, description: 'All cards for the list retrieved successfully' }) 
  @ApiNotFoundResponse({ description: 'List not found' }) 
  @Get('/list/:listId')
  async findAllCardsByListId(@Param('listId', ParseUUIDPipe) listId: string) {
    return this.cardService.findAllCardsByListId(listId);
  }
